// The result is the same with ex11.33, since the sequence of elements in the
// dictionary is irrevelant.
#include <iostream>
#include <fstream>
#include <sstream>
#include <string>
...
typedef std::unordered_map<std::string, std::string> trans_type;
